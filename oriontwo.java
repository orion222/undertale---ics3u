...
public class oriontwo extends JPanel implements KeyListener, MouseListener, Runnable{
	...
	// z is the coordinates of either the exit or entrance
	...
	public oriontwo() {
		...
		try {
			...
			ruinsImages[0] = ImageIO.read(new File("assets/maps/ruins/ruins1.png"));
			ruinsImages[1] = ImageIO.read(new File("assets/maps/ruins/ruins2.png"));
			ruinsImages[2] = ImageIO.read(new File("assets/maps/ruins/ruins3.png"));
			ruinsImages[3] = ImageIO.read(new File("assets/maps/ruins/ruins4.png"));
		...
		// ruins1 entrance
		ruinsExits[0][0] = new dimension(new corner (1000, 1000), new corner (1000, 1000));
		// ruins1 exit
		ruinsExits[0][1] = new dimension(new corner (-50, 260), new corner (-50, 375));
	...
	// 0 means not within exit, 0 means go back to previous setting setting, 1 means go to next setting
