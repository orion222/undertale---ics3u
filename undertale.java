...
public class orion extends JPanel implements KeyListener, MouseListener, Runnable{
	...
	public static ArrayList<dimension>[] charaPos = new ArrayList[5];
	...
	public orion() {
		...
		// Positions of Chara
		// ruins1
		charaPos[1].add(new dimension(new corner(480, 220), new corner(480, 220))); // Initial position after menu
		charaPos[1].add(new dimension(new corner(65, 435), new corner(65, 435))); // In front of exit

		// ruins2
		charaPos[2].add(new dimension(new corner(950, 355), new corner(950, 355))); // In front of entrance
		charaPos[2].add(new dimension(new corner(175, 280), new corner(175, 280))); // In front of exit
